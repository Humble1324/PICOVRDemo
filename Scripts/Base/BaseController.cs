...
namespace UnityEngine.XR.Interaction.Toolkit
{
    ...
    public class BaseController : XRBaseController
    {
        [SerializeField] InputActionProperty m_PositionAction =
            new InputActionProperty(new InputAction("Position", expectedControlType: "Vector3"));
        ...
        [SerializeField] InputActionProperty m_RotationAction =
            new InputActionProperty(new InputAction("Rotation", expectedControlType: "Quaternion"));
        ...
        [SerializeField] InputActionProperty m_IsTrackedAction =
            new InputActionProperty(new InputAction("Is Tracked", type: InputActionType.Button)
        ...
        [SerializeField] InputActionProperty m_TrackingStateAction =
        ...
        [SerializeField] InputActionProperty m_SelectAction =
            new InputActionProperty(new InputAction("Select", type: InputActionType.Button));
        ...
        [SerializeField] InputActionProperty m_SelectActionValue =
            new InputActionProperty(new InputAction("Select Value", expectedControlType: "Axis"));
        ...
        [SerializeField] InputActionProperty m_ActivateAction =
            new InputActionProperty(new InputAction("Activate", type: InputActionType.Button));
        ...
        [SerializeField] InputActionProperty m_ActivateActionValue =
            new InputActionProperty(new InputAction("Activate Value", expectedControlType: "Axis"));
        ...
        [SerializeField] InputActionProperty m_UIPressAction =
            new InputActionProperty(new InputAction("UI Press", type: InputActionType.Button));
        ...
        [SerializeField] InputActionProperty m_UIPressActionValue =
            new InputActionProperty(new InputAction("UI Press Value", expectedControlType: "Axis"));
        ...
        [SerializeField] InputActionProperty m_UIScrollAction =
            new InputActionProperty(new InputAction("UI Scroll", expectedControlType: "Vector2"));
        ...
        [SerializeField] InputActionProperty m_HapticDeviceAction =
            new InputActionProperty(new InputAction("Haptic Device", type: InputActionType.PassThrough));
        ...
        [SerializeField] InputActionProperty m_RotateAnchorAction =
            new InputActionProperty(new InputAction("Rotate Anchor", expectedControlType: "Vector2"));
        ...
        [SerializeField] InputActionProperty m_DirectionalAnchorRotationAction =
            new InputActionProperty(new InputAction("Directional Anchor Rotation", expectedControlType: "Vector2"));
        ...
        [SerializeField] InputActionProperty m_TranslateAnchorAction =
            new InputActionProperty(new InputAction("Translate Anchor", expectedControlType: "Vector2"));
        ...
        [SerializeField] InputActionProperty m_ScaleToggleAction =
            new InputActionProperty(new InputAction("Scale Toggle", type: InputActionType.Button));
        ...
        [SerializeField] InputActionProperty m_ScaleDeltaAction =
            new InputActionProperty(new InputAction("Scale Delta", expectedControlType: "Vector2"));
        ...
        protected override void UpdateInput(XRControllerState controllerState)
        {
            ...
            {
                if (IsDisabledReferenceAction(m_SelectAction) || IsDisabledReferenceAction(m_ActivateAction) ||
                    IsDisabledReferenceAction(m_UIPressAction))
                {
                    Debug.LogWarning(
                        "'Enable Input Actions' is enabled, but Select, Activate, and/or UI Press Action is disabled." +
